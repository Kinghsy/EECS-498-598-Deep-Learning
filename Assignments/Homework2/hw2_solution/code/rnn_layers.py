...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (H, x, Wx, Wh, a, i, f, o, c, prev_c, prev_h, next_c, prev_h)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    H, x, Wx, Wh, a, i, f, o, c, prev_c, prev_h, next_c, prev_h = cache
    ...
    da_g = dg * (1 - np.tanh(a_c) ** 2)
    da = np.hstack((da_f, da_i, da_g, da_o))
    dx = np.dot(da, Wx.T)
